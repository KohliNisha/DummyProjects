		        					...
		        					<div class="comment-detail">
		        						<div class="comment-mesg-wrap">
			        						...
			        						<div class="comment-opt">
				        						@if( auth()->user()->id == $res->comment_by)<i class="fas fa-ellipsis-v" data-toggle="dropdown" aria-expanded="false"></i> @endif
											...
											*/
		        							...
		        							<li class="like-comment">
												...
												<ul class="like-comment-ul">
													...
													<li>
														<a href="javascript:;" class="unlikebutton" id="dislike_<?php echo $res->id; ?>"   onclick="comment_like_dislike('0','<?php echo $res->id; ?>');" >
				        						...
				        						<div class="nest-comment-box-in">
						        					...
						        					<div class="comment-detail">
						        						<div class="comment-mesg-wrap">
							        						...
							        						<div class="comment-opt">
								        						@if( auth()->user()->id == $value->comment_by)<i class="fas fa-ellipsis-v" data-toggle="dropdown" aria-expanded="false"></i> @endif
						        						...
						        						<ul class="repl-view-list">
															...
															*/
															...
															<li class="like-comment">
																<ul class="like-comment-ul">
																	<li>
																		<a href="javascript:;" class="likebutton" id="like_<?php echo $value->id; ?>"  onclick="comment_like_dislike('1','<?php echo $value->id; ?>');">
																			<img src="<?php echo $path; ?>/thumbs-up-icon.png">
