														...
														*/
														...
														<li class="like-comment">
															...
															<ul class="like-comment-ul">
																...
																<a href="javascript:;" class="likebutton" id="like_<?php echo $res->id; ?>" onclick="comment_like_dislike('1','<?php echo $res->id; ?>');" >
																...
																<li>
																	<a class="unlikebutton" id="dislike_<?php echo $res->id; ?>"  onclick="comment_like_dislike('0','<?php echo $res->id; ?>');">
...
<div class="modal fade share-popup" id="share-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      	...
      	<meta property=”og:url” content=”<?php echo urlencode(Request::fullUrl()); ?>” />
      	...
      	<meta property=”og:image” content=”<?php echo url('/uploads/').'/'.$videoDetails->video_thumbnail_file_path; ?>” />
				...
				<div class="text-center">
					<ul class="social-share-list">
						...
						<li>
							...
							?>
							<a href="https://twitter.com/intent/tweet?status=<?php echo $videoDetails->video_title; ?>+url= <?php echo urlencode(Request::fullUrl()); ?>" target="_blank" onclick="javascript:social_share('twitter')"><img src="<?php echo $path.'/twitter.png'; ?>" alt=""></a>
						</li>
						<li>
...
<script type="text/javascript">
	...
	function comment_like_dislike(type,id)
	{
		...
		if(type==1)
		{
			...
			$('#like_text_'+id).css('color','red');
			$('#dislike_text_'+id).css('color','black');
			/*$('.cmtdislike').addClass("cmtlike");
			$('.cmtlike').removeClass("cmtdislike");*/
		}
		...
		if(type==0)
		{
			...
			$('#like_count_'+id).html(new_like);
			$('#dislike_count_'+id).html(new_dislike);
			$('#like_text_'+id).css('color','black');
			$('#dislike_text_'+id).css('color','red');
