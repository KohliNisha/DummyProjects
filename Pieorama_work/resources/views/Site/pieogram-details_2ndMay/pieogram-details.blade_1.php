		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-4">
				<ul class="christanPieograms-wrapper clearfix">
					...
					@if(isset($getnextVideo) && isset($all_userss1))
					...
					$img='https://via.placeholder.com/300';
					if($getnextVideo->video_thumbnail_file_path!='')
					{
					$thumb=$getnextVideo->video_thumbnail_file_path;
					$str=strpos($thumb, 'cloudinary');
					if ($str=='') 
					{
					$img=$path.'/'.$thumb;
					...
					<li>
						<div class="vid_bx">
							 ...
							 <div class="thumbnail" onmouseover="bigImg('<?php echo url('/').'/watch/?p='.$video_idddd; ?>', '<?php echo $getnextVideo->id; ?>')" onmouseout="bigImg2('<?php echo url('/').'/watch/?p='.$video_idddd; ?>', '<?php echo $getnextVideo->id; ?>')">
								<a href="{!! url('watch/?p='.base64_encode(base64_encode($getnextVideo->id)))  !!}"> 
									...
									<img src="<?php echo $img; ?>" alt="image" class="imghome_<?php echo $getnextVideo->id; ?>" > 
									   <video  data-play = "Hover"  class="postervideo1_<?php echo $getnextVideo->id; ?>" style="display: none; width: 100%; height: 137px;" muted="muted">
									  	 <source src="<?php echo url('/uploads/').'/'.$getnextVideo->video_file_path; ?>" type="video/mp4">

								 	  </video> 
									<div class="middle">
										<div class="text">{{ substr($getnextVideo->video_title, 0,28) }}</div>
									</div>
								</a>
							</div>
