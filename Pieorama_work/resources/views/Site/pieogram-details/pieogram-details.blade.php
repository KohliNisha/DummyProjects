							...
							<div class="col-xl-6 col-lg-6 side-share text-lg-right mt-3 mt-lg-0">
								...
								<ul>
									...
									<li class="source_video pl-0">
										...
										@else
										  <a data-toggle="modal" data-target="#video-popup" tabindex="0" style="cursor: pointer; color: #000;"><span>Source</span>
											<img style="vertical-align: top;" src="<?php echo $path; ?>/video_source.png">
										</a>
										@endif
									...
									<li class="source_video pl-0">
										...
										@else
										  <a data-toggle="modal" data-target="#animatedvideo-popup" tabindex="0" style="cursor: pointer; color: #000;"><span>GIF</span>
											<img style="vertical-align: top;" src="{{asset('website/images/Animated_GIF_button-optimised.jpg')}}">
										</a>
										@endif
									...
									<div class="row justify-content-between mt-2 mb-2">
										<div class="col-auto">
											@if(!empty(auth()->user()))
												...
												<a href="{!! url('/pieorama-user-profile'); !!}/{{$getnextVideo->userprofile_id}}" style="color:#000;">
