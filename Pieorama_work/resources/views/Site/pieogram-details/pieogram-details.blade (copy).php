						...
						<div class="pt-3">
							...
							<div class="media pt-0 pb-4 mt-3 mt-md-0">
								<div class="user-image mt-0 mr-3">
									...
									<img src="<?php echo url('uploads').'/'.$video_user['profile_image']; ?>" alt="">
								</div>
									...
									<ul>
										<li>
											<div class="comment-box-in">
												...
												<img src="<?php if(isset(auth()->user()->profile_image)){ ?>{{asset('uploads')}}/{{ auth()->user()->profile_image }}<?php } ?>" alt="" class="comment-userImage">
												@else
									...
									<ul class="comment-box-list" >
										...
										<li class="border_btm comment_row row_<?php echo $res->id; ?>" >
											<div class="comment-box-in">
												...
												<img src="{{asset('uploads')}}/{{$res->getprofile_image->profile_image}}" alt="" class="comment-userImage">
													...
													<script src="https://code.jquery.com/jquery-1.11.0.min.js"></script>
														...
														<div class="nest-comment-box">
															<div class="nest-comment-box-in">
																...
																<img src="{{asset('uploads')}}/{{$value->getprofile_image->profile_image}}" alt="" class="comment-userImage">
					...
					<ul class="social-share-list">
						<li>
							...
							?>
							 ...
							 <a href="#" target="_blank" onclick="javascript:social_share('facebook','{{$geturl}}','{{$videoDetails->video_title}}','{{$desc}}','{{$imgshare}}')"><img src="<?php echo $path.'/facebook.png'; ?>" alt=""></a>
