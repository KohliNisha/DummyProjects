            ...
            <div class="card">
                <div class="card-body">
                   ...
                   <div class="template-demo">
                      ...
                      <a href="/admin/queryreports"><button type="button" class="btn btn-primary btn-fw">Query Report</button></a>
                    </div>
                 </div>
               ...
               <div class="card-body" style="padding-top: 0px;">
                 <div class="template-demo">
                    ...
                    <form method="post" style="display: inline;"> @csrf <input type="hidden" value="user" name="alluser"> <button type="submit" style="margin-top: 20px;" class="btn btn-gradient-secondary">All Query Report</button></form>
                  </div>
                <hr/>
