      ...
      <nav aria-label="breadcrumb">
       ...
       <div class="card-body" style="padding-top: 0px;">
         <div class="template-demo">
            ...
            <form method="post" style="display: inline;"> @csrf <input type="hidden" value="user" name="alluser"> <button type="submit" style="margin-top: 20px;" class="btn btn-gradient-secondary">All Loan Report</button></form>
          </div>
        <hr/>
                ...
                <div class="week-data week-picker" style="display: none;">
                  ...
                  <div class="data allreport" >
                    ...
                    @foreach($data as $key=>$loan) 
                      ...
                      <td>  GHC {{$loan->requested_loan_amount}} </td> 
                      <td> {{date('Y/m/d', strtotime($loan->created_at))}}  </td> 
                      <td>   @if($loan->status =='0')                          
                        <label class='badge badge-warning cursor' style='color: #292727;' >Pending</label>
                        @endif
                        
                        @if($loan->status =='1')                        
                        <label><label class='badge badge-danger cursor' style='background-color: #e693a4;'>T&C Pending</label></a></label> 
                        @endif

                        @if($loan->status =='2') 
                        <label class='badge badge-danger cursor' style='background-color: #e0002d;'>Declined</label>    
                        @endif

                        @if($loan->status =='3') 
                        <label class='badge badge-info cursor'>T&C Accepted</label>
                        @endif

                        @if($loan->status =='4') 
                        <label class='badge badge-success cursor'>Loan Approved</label>
                        @endif

                        @if($loan->status =='5') 
                        <label class='badge badge-success cursor' style='background-color: #495057;'>Loan Completed</label>
                        @endif </td> 
