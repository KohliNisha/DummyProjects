...
<div class="content-wrapper">
 ...
 <div class="page-header">
     ...
     Channels Report
      ...
      <h4>Click below to genrate the report</h4>
     ...
     <div class="row">
       ...
       <div class="card-body" style="padding-top: 0px;">
         <div class="template-demo">
            ...
            <form method="post" style="display: inline;"> @csrf <input type="hidden" value="user" name="alluser"> <button type="submit" style="margin-top: 20px;" class="btn btn-gradient-secondary">All Channels Report</button></form>
          </div>
                   ...
                   <input type="submit" class="btn btn-gradient-primary mr-2" value="Submit">
                    ...
                    <table class="table display table-bordered table-striped" id="example">
                       <thead>  
                        <tr>
                          <th> S.N</th>    
                          <th> pieogram Title </th>
                          <th> pieogram Description </th>
                          <th> Created at </th>
                          <th> Status</th>
                        </tr>
                      </thead>
                    ...
                    @foreach($data as $key=>$user) 
                      <tr>
                        <td>  {{++$key}} </td>
                        <td>  {{ $user->video_title}} </td>
                        <td>  {{$user->video_description}} </td>
