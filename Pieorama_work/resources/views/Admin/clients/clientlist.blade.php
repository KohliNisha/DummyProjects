             ...
             $(document).ready(function () { 
                ...
                $('#usersjtable').jtable({
                        ...
                        actions: {
                            ...
                            listAction: "{{ route('admin.clientsajax') }}",
                     ...
                     /* first_name: {
                      ...
                      phone_number: {
                            ...
                            display:function(data)
                            { 
                              if(data.record.phone_number){
                               return ""+data.record.phone_code+" - "+data.record.phone_number+"";
                              }
                            }
                          },  
                     ...
                     */
                      ...
                      status: {
                            title: 'Account<br/> Status',
                            width: '10%',
                            sorting: true, //This column is not sortable!
                            display:function(data)
                            {
                              if(data.record.status == 1){
                               return "<label class='badge badge-gradient-success activatedAccount' data-id='"+data.record.id+"'  data-id1='1'>Active</label>";
                              } else {
                                 return "<label class='badge badge-gradient-warning activatedAccount' data-id='"+data.record.id+"' data-id1='0'>Inactive</label>";
                       ...
                       Action: {
                            ...
                            display:function(data)
                            {
                               ...
                               return "<a title='View details' data-id='"+data.record.id+"' href='{!! url('/admin/userdetails'); !!}/"+data.record.id+"'><i class='mdi mdi-eye size25px'></i></a> <a title='Delete User' class='accountDelete' data-id='"+data.record.id+"' href='javascript:void(0)'><i class='mdi mdi-delete size25px'></i></a> <a title='Edit User' href='{!! url('/admin/user-edit'); !!}/"+ids+"'><i class='mdi mdi-pencil size25px'></i></a>";
