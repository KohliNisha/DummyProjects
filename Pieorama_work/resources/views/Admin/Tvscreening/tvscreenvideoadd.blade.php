      ...
      <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-body">         
          ...
          @if ($errors->any())
            ...
            @endif       
          <form class="forms-sample"  autocomplete="off" id="PieogramForm" method="post" action="{{ route('admin.addtvscreeningfile')}}" enctype="multipart/form-data">
           @csrf
            ...
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="title" maxlength="256" value="{{ old('title') }} " placeholder="Title" class="form-control" value="">
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                   ...
                   <textarea class="form-control" name="notes" id="exampleTextarea12" rows="4" spellcheck="false">{{ old('notes') }}</textarea>
                </div>
              </div>
            </div>
          </div>
