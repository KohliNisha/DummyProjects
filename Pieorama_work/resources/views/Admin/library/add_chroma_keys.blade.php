...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">         
          <h4 class="card-title">Add Chroma Key</h4>  
          <hr/><br/>  
          @if ($errors->any())
            ...
            @endif       
          <form class="forms-sample"  autocomplete="off" id="AudioForm" method="post" action="{{ route('admin.add_chroma_keys') }}" enctype="multipart/form-data">
           @csrf
          <!-- <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="name" maxlength="256" value="{{ old('name') }}" placeholder="Name" class="form-control" value="">
                </div>
              </div>
            </div>
         ...
         <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Image <sup>*</sup></label>
                <div class="col-sm-9">
