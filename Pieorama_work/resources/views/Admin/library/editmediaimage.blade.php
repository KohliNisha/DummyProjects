      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           <a href="{!! url('/admin/image-library'); !!}" class="btn btn-info  btn-sm">Back</a>  
          </li>
        </ol>
      </nav>
    </div>
       ...
       <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 <h4 class="card-title">Add New Image File (Only jpeg,jpg,png are allowed, MAX 5MB)</h4>  
                  <hr/><br/> 
                  @if ($errors->any())
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" maxlength="256"  value="{{ old('title', $profile->title) }}" placeholder="Title of Image" class="form-control"  >
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label"></label>
                        <div class="col-sm-9">  
                        <img src="{{  $profile->file_name }}" id="image_upload_preview" style="background: #e0c9c9; max-height: 200px;" />               
                        </div>
                      </div>
                    </div>
                  </div>
