      ...
      <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-body">         
          ...
          @if ($errors->any())
            ...
            @endif       
          <form class="forms-sample"  autocomplete="off" id="AudioForm" method="post" action="{{ route('admin.audioAdd') }}" enctype="multipart/form-data">
           @csrf
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="title" maxlength="256" value="{{ old('title') }}" placeholder="Title of Audio" class="form-control" value="">
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <select class="form-control" name="type" id="type">
                              <option value="{{ old('type') }}1" selected>Splat Sound</option>
                              <option value="{{ old('type') }}2">Other Sound</option>
                          </select>
                      </div>
                  </div>
              </div>
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">sound <sup>*</sup></label>
                <div class="col-sm-9">
            ...
            <!-- <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Audio file <sup>*</sup></label>
                <div class="col-sm-9">
                    <input type="file" name="library_file" class="" id="library_file" class="form-control" />
                </div>
              </div>
