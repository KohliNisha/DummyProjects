...
<div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">
      Library Management- Audience Reaction
      </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           <a href="{!! url('/admin/add-audiencereactions'); !!}" class="btn btn-info  btn-sm">Add New</a>  
          </li>
        </ol>
      </nav>
    </div>
                     ...
                     /* sno: {
                      ...
                      name: {
                       ...
                       url: {
                            ...
                            display:function(data)
                            {
                              var p_image = data.record.url;
                              return "<a title='View Video' class='btn btn-gradient-primary btn-sm' data-id='"+data.record.id+"' href='"+p_image+"' target='_blank'><i class='mdi mdi-video'></i></a>";
                       ...
                       Action: {
                            ...
                            display:function(data)
                            {
                               return "<a title='Delete audience reaction' class='audienceReaction_Delete' data-id='"+data.record.id+"' href='javascript:void(0)'><i class='mdi mdi-delete size25px'></i></a> <a title='Edit audience reaction' href='{!! url('/admin/edit-audience_reaction'); !!}/"+data.record.id+"'><i class='mdi mdi-pencil size25px'></i></a>";                               
                            }
                          }, 
                        }
                    });
