      ...
      <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-body">         
          ...
          @if ($errors->any())
            ...
            @endif       
          <form class="forms-sample"  autocomplete="off" id="AudioForm" method="post" action="{{ route('admin.imageAdd') }}" enctype="multipart/form-data">
           @csrf
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="title" maxlength="256" value="{{ old('title') }}" placeholder="Title of Image" class="form-control" value="">
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Image file <sup>*</sup></label>
                <div class="col-sm-9">
           ...
           <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label"></label>
                <div class="col-sm-9">
                   <img src="" id="image_upload_preview" style="background: #e0c9c9; max-height: 200px;" /> 
                </div>
              </div>
            </div>
          </div>
