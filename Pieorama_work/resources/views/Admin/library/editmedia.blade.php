      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           <a href="{!! url('/admin/audio-library'); !!}" class="btn btn-info  btn-sm">Back</a>  
          </li>
        </ol>
      </nav>
    </div>
       ...
       <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 <h4 class="card-title">Add New Audio File (Only mp3 are allowed, MAX 10MB)</h4>  
                  <hr/><br/> 
                  @if ($errors->any())
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" maxlength="256"  value="{{ old('title', $profile->title) }}" placeholder="Title of Audio" class="form-control"  >
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Update Tags</label>
                        <div class="col-sm-9">
                         <textarea class="form-control" name="library_tags" id="library_tags" rows="4" spellcheck="false">{{ old('library_tags', $profile->library_tags) }}</textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                          <div class="form-group row">
                              <label class="col-sm-3 col-form-label">sound Category<sup>*</sup></label>
                              <div class="col-sm-9">
                                  <select class="form-control" name="type" id="type">

                                      <option value="1" @if($profile->type == 1) selected @endif>Splat Sound</option>
                                      <option value="2" @if($profile->type == 2) selected @endif>Other Sound</option>
                                  </select>
                              </div>
                          </div>
                      </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Update Audio </label>
                        <div class="col-sm-9">
                     ...
                     <div class="col-sm-6">     
                           <?php  
                              ...
                              if(!empty($profile->file_name))
                              {
                                ?>
                                        <audio controls>
                                          <source src="{{ $profile->file_name }}" type="audio/*"> 
                                         
                                         
                                        </audio>
                                      
                                       <!--  <source src="{{ $profile->file_name }}" type="audio/*"></audio>   -->
                              <?php
                              }
                              ?>       
                        </div>
