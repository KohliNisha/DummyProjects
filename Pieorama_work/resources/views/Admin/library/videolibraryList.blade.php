...
<div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">
      Library Management- Videos
      </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           <a href="{!! url('/admin/add-video-file'); !!}" class="btn btn-info  btn-sm">Add New</a>  
          </li>
        </ol>
      </nav>
    </div>
            ...
            <script type="text/javascript">             
             $(document).ready(function () { 
                ...
                $('#usersjtable').jtable({
                        ...
                        actions: {
                            listAction: "{{ route('admin.libraryajaxvideo') }}",
                        },
                        fields: {
                      /*sno: {
                            key: true,
                      ...
                      title: {
                       ...
                       file_name: {
                            ...
                            display:function(data)
                            {
                               ...
                               return "<a title='View Video' class='btn btn-gradient-primary btn-sm' data-id='"+data.record.id+"' href='"+file_path+"' target='_blank'><i class='mdi mdi-video'></i></a>";
                   ...
                   /*    created_at: {
                      ...
                      status: {
                       ...
                       Action: {
                            ...
                            display:function(data)
                            {
                               return "<a title='Delete Media' class='libraryMediaDelete' data-id='"+data.record.id+"' href='javascript:void(0)'><i class='mdi mdi-delete size25px'></i></a> <a title='Edit Media' href='{!! url('/admin/edit-media-video'); !!}/"+data.record.id+"'><i class='mdi mdi-pencil size25px'></i></a>";
