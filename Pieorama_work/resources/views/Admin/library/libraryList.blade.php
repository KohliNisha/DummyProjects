...
<div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">
      Library Management- Audios
      </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           <a href="{!! url('/admin/add-audio-file'); !!}" class="btn btn-info  btn-sm">Add New</a>  
          </li>
        </ol>
      </nav>
    </div>
             ...
             $(document).ready(function () {
                ...
                $('#usersjtable').jtable({
                        ...
                        actions: {
                            ...
                            listAction: "{{ route('admin.libraryajax') }}",
                     ...
                     /* sno: {
                      ...
                      title: {
                       ...
                       file_name: {
                            ...
                            display:function(data)
                            {
                                if(data.record.file_type == 2){
                                    var file_path = data.record.file_name;
                                    return "<a title='View Audio' class='btn btn-gradient-primary btn-sm' data-id='"+data.record.id+"' href='"+file_path+"' target='_blank'><i class='mdi mdi-music-note'></i></a>";
                                }else {

                                    return "<a title='View Audio' class='btn btn-gradient-primary btn-sm' data-id='" + data.record.id + "' href='" + data.record.file_name + "' target='_blank'><i class='mdi mdi-music-note'></i></a>";
                                }
...
/*
                       ...
                       Action: {
                            ...
                            display:function(data)
                            {
                               return "<a title='Delete media' class='libraryMediaDelete' data-id='"+data.record.id+"' href='javascript:void(0)'><i class='mdi mdi-delete size25px'></i></a> <a title='Edit Media' href='{!! url('/admin/edit-media'); !!}/"+data.record.id+"'><i class='mdi mdi-pencil size25px'></i></a>";                               
                            }
                          }, 
                        }
                    });
