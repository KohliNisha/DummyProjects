       ...
       <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" autocomplete="off" method="post" action="{{ route('admin.addnewmail') }}">
                  @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input type="text" name="replace_vars" class="form-control" value="{{ old('replace_vars') }}">
