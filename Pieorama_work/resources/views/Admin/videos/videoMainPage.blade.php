...
<div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title"> Pieogram Main Page video </h3>
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="background_color" maxlength="256"  value="{{ old('background_color', $profile->background_color) }}" placeholder="Background Color Code" class="form-control"  >
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="foreground_color" maxlength="256"  value="{{ old('foreground_color', $profile->foreground_color) }}" placeholder="Foreground Color Code" class="form-control"  >
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="file" name="library_file" id="library_file" class="form-control" />
            ...
            <div class="row">
             ...
             <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label"></label>
                  <div class="col-sm-9"> 
                    <img src="{{$profile->file_image}}" width="200px" height="100px">
